                        ...
                        <form action="<?= BASE_URL_ADMIN . '?act=them-san-pham' ?>" method="POST" enctype="multipart/form-data">
                            <div class="row card-body">
                                ...
                                <div class="form-group col-12">
                                    ...
                                    <select class="form-control" name="danh_muc_id" aria-label="Default select example">
                                ...
                                <div class="form-group col-12">
                                    ...
                                    <select class="form-control" name="trang_thai" aria-label="Default select example">
